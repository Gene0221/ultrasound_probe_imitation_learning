...
```bash
bash ./launch.bash --robot-ip 172.16.0.2 --speed-scale 0.1
```
...
```bash
bash ./launch.bash --robot-ip 172.16.0.2 --trajectory /path/to/session_0001/franka_replay/replay_trajectory.csv --speed-scale 0.1
```
