...
Options:
  ...
  --config <file>        YAML config. Default: ../config/infer.yaml, or IMITATION_LEARNING_INFER_CONFIG.
...
Environment overrides:
  ROBOT_IP
  IMITATION_LEARNING_INFER_CONFIG
  BUILD_DIR
  BUILD_TYPE
...
CONFIG_FILE="${IMITATION_LEARNING_INFER_CONFIG:-${REALTIME_DIR}/config/infer.yaml}"
ROBOT_IP="${ROBOT_IP:-}"
